            ...
            <section className="p-5 d-flex justify-content-center conteudo m-3 rounded-5">
                <div className="container">
                    <div className="row row-cols-1 row-cols-md-2 g-4">
                        <div className="col">
                            <h1 className="display-4 titulo mt-4 mb-0 pb-0">Bem-vindo ao meu portfólio!</h1>
                            <p className="texto-descricao">Desenvolvedor Full Stack com ênfase em Front-End <br />
                            <i>Criando interfaces modernas e responsivas.</i></p>
                            <hr />
            ...
            <section className="conteudo rounded-5 p-5 d-flex justify-content-center m-3">
                <div className="container d-flex justify-content-center">
                    <div className="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 d-flex justify-content-center">
                        <div className="col d-flex my-auto mt-2">
                        ...
                        <div className="col d-flex my-auto mt-2">
                            <Link to="www.linkedin.com/in/daniel-henrique-leão-de-oliveira-6020a0369" className="btn linkedin mx-auto my-auto" target="_blank">Meu LinkedIn
