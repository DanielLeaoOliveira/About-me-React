                ...
                <div className="container d-flex justify-content-center">
                    <div className="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 d-flex justify-content-center">
                        <div className="col d-flex my-auto">
                            <a href="#" className="btn github mx-auto my-auto">Meu Github
                                <img src={github} className="img-fluid rounded-5 icone-btn m-1" alt="Imagem de exemplo" />
                            </a>
                        </div>
                        <div className="col my-auto">
                            <a href="#" className="btn mx-auto my-auto">Meu LinkedIn</a>
                        </div>
                        <div className="col my-auto">
                            <a href="#" className="btn mx-auto my-auto">Baixe meu Currículo</a>
                        </div>
                    </div>
                </div>
